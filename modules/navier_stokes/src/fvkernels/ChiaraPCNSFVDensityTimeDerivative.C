...
registerMooseObject("NavierStokesApp", ChiaraPCNSFVDensityTimeDerivative);
...
ChiaraPCNSFVDensityTimeDerivative::ChiaraPCNSFVDensityTimeDerivative(const InputParameters & parameters)
...
ADReal
ChiaraPCNSFVDensityTimeDerivative::computeQpResidual()
{
  return (_u[_qp] * _rho_dot[_qp] + _u_dot[_qp] * _rho[_qp]);
}
