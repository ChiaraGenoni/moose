...
[Samplers]
  [cartesian]
    type = InputMatrix
    matrix = '${fparse pellet_height*4}; ${fparse pellet_height*5}; ${fparse pellet_height*6}; ${fparse pellet_height*7}; ${fparse pellet_height*8};'
